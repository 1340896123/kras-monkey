...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'definition/:kind(itemtype|property|relationship|lifecycle|workflow|method)/:id?', name: 'definition-edit', component: () => import('@/pages/DefinitionEditorPage.vue'), meta: { title: '定义编辑' } },
      { path: 'users', name: 'users', component: () => import('@/pages/UsersPage.vue'), meta: { title: '用户管理' } },
      { path: 'menu-management', name: 'menu-management', component: () => import('@/pages/MenuManagementPage.vue'), meta: { title: '菜单管理' } },
